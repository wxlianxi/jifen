...
import cn.tianjin.xxl.jifen.application.JifenApplication;
...
//	private static final String TAG = "HttpRequest";
    ...
    /**基础URL，这里服务器设置可切换*/
    public static final String URL_BASE = SettingUtil.getCurrentServerAddress(JifenApplication.getInstance());
     ...
     * @param listener
     */
    public static void getUser(long userId, final int requestCode, final HttpManager.OnHttpResponseListener listener) {
        List<Parameter> paramList = new ArrayList<Parameter>();
     ...
     * @param listener
     */
    public static void getUserList(int range, int pageNum, final int requestCode, final HttpManager.OnHttpResponseListener listener) {
        List<Parameter> paramList = new ArrayList<Parameter>();
        addExistParameter(paramList, KEY_CURRENT_USER_ID, JifenApplication.getInstance().getCurrentUserId());
