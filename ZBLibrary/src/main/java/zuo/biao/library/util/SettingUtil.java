...
public final class SettingUtil {
	 ...
	 * TODO 改为你的正式服务器地址
	 */
	public static final String URL_SERVER_ADDRESS_NORMAL_HTTPS = "http://115.29.251.155/index.php/Home/Index/test";//正式服务器
	/**
	 * TODO 改为你的测试服务器地址,如果有的话
	 */
	public static final String URL_SERVER_ADDRESS_TEST = "http://115.29.251.155/index.php/Home/Index/testtest";//测试服务器
